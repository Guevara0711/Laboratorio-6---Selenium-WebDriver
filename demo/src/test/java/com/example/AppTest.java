...
public class AppTest 
{
    ...
    public static Object[][] proveedorDatos(){
        return new Object[][] {
            ...
            {"masculino", "0", "Debe ingresar su edad para poder realizar la cotización"},
            {"femenino", "17", "La edad del cotizante debe ser mayor o igual a 18 años"},
            {"femenino", " ", "Debe ingresar su edad para poder ingresar la cotización"},
    ...
    public void testColsultarPrimaAnual(String genero, String edad, String salida_esperada) throws InterruptedException {
        Thread.sleep(1000);
